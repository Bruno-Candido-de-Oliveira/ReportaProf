...
Especificamente nesse repositório está apenas back-end do sistema com endpoints consumidos principalmente para o "lado professor" da aplicação.
O fluxo principal é:
...
Foi utilizado no projeto Django Rest Framework para a implementação do back-end. A escolha do DRF se dá pela praticidade de implementação e gerenciamento, pois a ferramenta oferece ORM nativo e painel administrador.
